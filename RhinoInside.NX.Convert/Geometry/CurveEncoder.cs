...
namespace RhinoInside.NX.Convert
{
    public static class CurveEncoder
    {
        ...
        #region Curve
        public static NXOpen.Curve ToCurve(this Curve value, double factor)
        {
            switch (value)
            {
                case LineCurve line:
        ...
        public static NXOpen.Curve ToCurve(this Curve value) => value.ToCurve(UnitConverter.RhinoToNXUnitsRatio);
