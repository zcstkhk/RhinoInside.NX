...
using RhinoInside.NX.Convert.System.Drawing;
using RhinoInside.NX.External.DB.Extensions;
using RhinoInside.NX.External.UI.Extensions;
using DB = NXOpen;
...
namespace RhinoInside.NX.GH.Types
{
  ...
  {
    public override string TypeDescription => "Represents a NX geometric element";
    ...
    class Preview : IDisposable
    {
      ...
      void Build()
      {
        ...
        {
          var element = geometricElement.Document.GetElement(geometricElement.Tag);
          if (element is null)
            return;
    ...
    public override void DrawViewportMeshes(GH_PreviewMeshArgs args)
    {
      ...
      var element = Document?.GetElement(Tag);
      if (element is null)
      {
        const int factor = 3;
    ...
    where X : DB.GeometryObject
  {
    ...
    protected GeometryObject(NXOpen.Part doc, NXOpen.TaggedObject reference)
    {
  ...
  public class Vertex : GeometryObject<NXOpen.Point>, IGH_PreviewData
  {
  ...
  public class Edge : GeometryObject<NXOpen.Edge>, IGH_PreviewData
  {
    public override string TypeName => "NX Edge";
    public override string TypeDescription => "Represents a NX Edge";

    public Edge() { }
    public Edge(NXOpen.Edge edge) : base(edge) { }
    public Edge(NXOpen.Part doc, NXOpen.TaggedObject reference) : base(doc, reference) { }
