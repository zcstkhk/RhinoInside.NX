...
namespace RhinoInside.NX.Translator.Geometry
{
    ...
    public static class GeometryDecoder
    {
        ...
        { var rhino = RawDecoder.ToRhino(value); UnitConverter.Scale(ref rhino, UnitConverter.NXToRhinoUnitsRatio); return rhino; }

        public static Transform ToTransform(this NXOpen.Matrix4x4 value)
        { var rhino = RawDecoder.ToRhinoTransform(value); UnitConverter.Scale(ref rhino, UnitConverter.NXToRhinoUnitsRatio); return rhino; }
